...
// === SELECTORES ===
const productContainer = document.querySelector('#contenedor-r-ingresados');
const paginationContainer = document.querySelector('#pagination-nav-r-ingresados');
...
fetch("./json/productos_recien_ingresados.json")
