...
// === SELECTORES ===
const productContainer = document.querySelector('#contenedor-destacados');
const paginationContainer = document.querySelector('#pagination-nav-destacados');
...
fetch("./json/productos_destacados.json")
